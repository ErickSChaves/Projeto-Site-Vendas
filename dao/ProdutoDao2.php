...
<?php
    ...
    class ProdutoDao2{
        ...
        public static function listar2($produto){
            $conexao = Conexao::conectar();
            $querySelect = "SELECT idProduto, nomeProduto, fotoProduto, PrecoProduto FROM tbproduto WHERE idProduto = ?";
        ...
        public static function atualizar($produto) {
            $conexao = Conexao::conectar();
            $queryUpdate = "UPDATE tbproduto SET NomeProduto = ?, fotoProduto = ?, PrecoProduto = ?, WHERE idProduto = ?";
