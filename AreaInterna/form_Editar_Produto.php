...
<html lang="en">
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <?php
        ...
        try {
            ...
            $lista = ProdutoDao::listar2($produto);
    ...
    ?>
       ...
       <div class="form-box" style=" margin-left: 50% ">
        ...
        <form method = "post" action="../Cadastros/editarCategoria.php?idCategoria=<?php echo $lista['idProduto'] ?>" div class="register-form">
        ...
        <div class="input-group">
                    <label for="password"> Produto que vai ser editada: </label>
                    <input readonly placeholder="<?php echo $lista['nomeProduto'] ?>"  >
                </div>
                <div class="input-group">
                    <label for="password"> Nome Produto: </label>
                    <input type="text" name="nomeProduto" id="nomeProduto" placeholder="<?php echo $lista['nomeProduto'] ?>" >
                </div>

                <div class="input-group">
                    <label for="password"> Preço: </label>
                    <input type="text" name="precoProduto" id="precoProduto" placeholder="<?php echo $lista['precoProduto'] ?>" >
                </div>
                ...
                <div class="input-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="categoria" name="categoria" class="form-control">
                                        <option selected><?php echo $lista['nomeCategoria'] ?></option>
