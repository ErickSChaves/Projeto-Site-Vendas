...
<html lang="en">
    ...
    ?>
        ...
        <form method = "post" action="../Cadastros/excluirCategoria.php?idCategoria=<?php echo $lista['idCategoria'] ?>" div class="register-form">
        ...
        <div class="input-group">
                    <label for="password"> Categoria que vai ser excluida: </label>
