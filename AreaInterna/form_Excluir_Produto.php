...
<html lang="en">
    ...
    ?>
        ...
        <form method = "post" action="../Cadastros/excluirProduto.php?idProduto=<?php echo $lista['idProduto'] ?>" div class="register-form">
        ...
        <div class="input-group">
                    <label for="password"> Produto que vai ser excluido: </label>
