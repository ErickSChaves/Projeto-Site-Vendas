...
<html lang="en">
    ...
    ?>
        ...
        <form method = "post" action="../Cadastros/cadastroCategoria.php" div class="register-form">
				...
				<div class="col-md-12">
					<div class="table-wrap">
                        ...
                        <tr>
                            ...
                            <td><a href="form_Editar_Categoria.php?idCategoria=<?php echo $categoria['idCategoria']; ?>" class="btn">Editar</a></td>
                            <td><a href="form_Excluir_Categoria.php?idCategoria=<?php echo $categoria['idCategoria']; ?>" class="btn" >Excluir</a></td> 
                        </tr>
                        <?php } ?>
                </tbody>
					  </table>
